...
const CariMobil = () => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}/customer/v2/car`, { params })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/customer/v2/car`)
      .then((res) => {
        setCars(res.data.cars);
      })
      .catch((err) => console.log(err));
          ...
          <div className={`cari ${visible ? "cari-active" : ""}`} onClick={() => setVisible(true)}>
            <div className="col-lg-6 cari1">
              ...
              <div className="col-sm-6 col-lg-6 cariitem">
                <h3>Kategori</h3>
                <div className="boxselect">
                  <Form.Select aria-label="Default select example" className="selecttext" onChange={(e) => setCategory(e.target.value)}>
            ...
            <div className="col-lg-6 cari1">
              ...
              <div className="col-sm-6 col-lg-6 cariitem">
                ...
                <div className="withbtn">
                  <div className="boxselect">
                    <Form.Select aria-label="Default select example" className="selecttext">
              ...
              <div className="col-lg-4 col-xl-4 col-sm-12 col-md-6 ">
                <div className="card p-3">
                  ...
                  <div className="card-body">
                    ...
                    <h4 className="harga">{`${car.price.toLocaleString("id-ID", { style: "currency", currency: "IDR" })}  / hari`}</h4>
                    <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                    <div className="d-grid gap-2 pilihcar">
                      <Link to={`/detail-mobil/${car.id}`} className="btn btn-" type="button">
                        <p>Pilih Mobil</p>
                      </Link>
                    </div>
                  </div>
